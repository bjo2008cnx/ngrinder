 ...
 *
 * This class save and retrieve {@link org.ngrinder.script.model.FileEntry} from Local SVN folders.
 *
 * @author JunHo Yoon
 * @since 3.0
 */
...
public class FileEntryRepository {
    ...
    /**
     * Initialize the {@link org.ngrinder.script.repository.FileEntryRepository}. This method should be
    ...
    /**
     * Return all {@link org.ngrinder.script.model.FileEntry}s under the given path.
     *
     * @param user     user
     * @param path     path under which files are searched.
     * @param revision . null if head.
     * @return found {@link org.ngrinder.script.model.FileEntry}s
     */
    ...
    /**
     * Return all {@link org.ngrinder.script.model.FileEntry}s which user have. It excludes
     * {@link org.ngrinder.script.model.FileType#DIR} entries.
     *
     * @param user user
     * @return found {@link org.ngrinder.script.model.FileEntry}s
     */
    ...
    /**
     * Return a {@link org.ngrinder.script.model.FileEntry} for the given path and revision.
     *
     * @param user     user
     * @param path     path in the svn repo
     * @param revision revision of the file
     * @return found {@link org.ngrinder.script.model.FileEntry}, null if not found
     */
    public FileEntry findOne(User user, String path, SVNRevision revision) {
        ...
        try {
            ...
            if (script.getFileType().isEditable()) {
                ...
                script.setContent((new String(byteArray, autoDetectedEncoding)).replaceAll("&quot;","\"")); //fix compile problem
    ...
    /**
     * Save fileEntry on the {@link org.ngrinder.script.model.FileEntry.getPath()} location.
     *
     * @param user      the user
    ...
    /**
     * Copy {@link org.ngrinder.script.model.FileEntry} to the given path.
     *
     * This method only work for the file not dir.
     *
     * @param user      user
     * @param path      path of {@link org.ngrinder.script.model.FileEntry}
